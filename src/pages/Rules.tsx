...
import aboutMarkdown from "@/content/rules.md?raw";
import {
    organizationJsonLd,
    pageJsonLd,
    websiteJsonLd,
...
export default function Rules() {
    ...
    return (
        <div className={styles.page}>
            <Seo
                title="Rules of the site"
                description="Community rules and guidelines for using REKKO. Learn how to interact, post and behave on the platform."
                canonicalPath="/rules"
                jsonLd={[
                    websiteJsonLd(),
                    organizationJsonLd(),
                    pageJsonLd({
                        ...
                        name: "Rules of REKKO",
                        description:
                            "Community rules and guidelines for using the REKKO platform.",
                    }),
                    {
                        "@context": "https://schema.org",
                        "@type": "CreativeWork",
                        name: "REKKO Community Rules",
                        description:
                            "Official community rules and behavioral guidelines for the REKKO platform.",
                        inLanguage: "en",
                        genre: "Community Guidelines",
                    },
