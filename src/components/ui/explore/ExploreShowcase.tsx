...
const styles = {
  ...
  grid: 'mt-8 grid grid-cols-[repeat(auto-fit,minmax(168px,1fr))] gap-x-5 gap-y-8 justify-items-center 2xl:grid-cols-[repeat(auto-fit,minmax(190px,1fr))]',
  miniGrid: 'mt-6 grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-x-5 gap-y-7 justify-items-center 2xl:grid-cols-[repeat(auto-fit,minmax(180px,1fr))]',
  ...
  animeCard: 'group flex w-full max-w-[255px] flex-col items-center gap-3 font-gabarito',
