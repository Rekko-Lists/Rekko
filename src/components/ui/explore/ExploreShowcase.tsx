...
const styles = {
  ...
  banner: 'relative flex h-[110px] items-center overflow-hidden bg-[#FF8A00] sm:h-[164px]',
  ...
  bannerSword: 'absolute right-[6%] top-1/2 z-10 h-[92px] translate-y-[-40%] translate-x-[-15%] object-contain drop-shadow-[0_4px_6px_rgba(0,0,0,0.2)] sm:h-[138px]',
  body: 'flex flex-1 flex-col px-4 pb-8 pt-6 sm:px-8 sm:pb-10 sm:pt-8',
  titleWrap: 'flex flex-col items-center',
  title: 'text-[30px] font-medium leading-none text-text-main sm:text-[40px]',
