...
const styles = {
  ...
  grid: 'mt-8 grid grid-cols-[repeat(auto-fit,minmax(130px,1fr))] gap-x-5 gap-y-8 justify-items-center xl:grid-cols-[repeat(auto-fit,minmax(168px,1fr))] 2xl:grid-cols-[repeat(auto-fit,minmax(190px,1fr))]',
  miniGrid: 'mt-6 grid grid-cols-[repeat(auto-fit,minmax(120px,1fr))] gap-x-5 gap-y-7 justify-items-center xl:grid-cols-[repeat(auto-fit,minmax(158px,1fr))] 2xl:grid-cols-[repeat(auto-fit,minmax(180px,1fr))]',
  ...
  animeCard: 'group flex w-full max-w-[200px] flex-col items-center gap-3 font-gabarito xl:max-w-[255px]',
