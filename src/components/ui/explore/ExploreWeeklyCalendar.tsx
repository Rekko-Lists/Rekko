...
const styles = {
  ...
  grid: 'relative z-10 grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-7',
  day: 'min-h-[204px] rounded-[14px] border border-border-light bg-app-bg/85 p-3 transition hover:-translate-y-0.5 hover:shadow-card',
